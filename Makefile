...
all: includes/private/swl-screenshot-server.h includes/private/xdg-shell-server.h includes/private/linux-dmabuf-server.h src/linux-dmabuf-server.c src/swl-screenshot-server.c src/xdg-shell-server.c $(TARGET) screenshot ipc-cli
